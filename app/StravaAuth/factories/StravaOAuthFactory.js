    ...
    return Object.create(null, {
        ...
        "getCode": {
            value: function() {
                return $http({
                    "method": "GET",
                    "url": "https://www.strava.com/oauth/authorize?client_id=21849&response_type=code&redirect_uri=http://goofy-mcnulty-b08d68.netlify.com/#!/strava-response&state=logged&approval_prompt=auto"
                }).then(r => {
                    console.log(r)
                })
            }
        ...
        "getToken": {
            value: (stravaCode) => {
                return $http({
                    ...
                    "data": {
                        client_id: process.env.strava-client-id,
                        client_secret: process.env.strava-secret,
                        code: stravaCode
                    }
                })
                // .then(response => {
